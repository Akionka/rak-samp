...
- [x] Extract environment and server metadata reads without moving mutations or
  the ABI table.
- [x] Extract the local chat-input text read without moving input mutations or
  the ABI table.
...
- [x] Extract SDK low-level packet/RPC wrappers behind the unchanged root type
  and exports.
- [x] Extract SDK event-listener wrappers behind the unchanged root type and
  exports.
...
- [x] Extract SDK local UI command wrappers behind the unchanged root type and
  exports.
- [x] Extract SDK text-label command wrappers behind the unchanged root type and
  exports.
- [x] Extract SDK textdraw command wrappers behind the unchanged root type and
  exports.
- [x] Extract SDK RakNet string-codec wrappers behind the unchanged root type
  and exports.
