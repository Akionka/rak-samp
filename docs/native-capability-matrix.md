...
| --- | --- | --- | --- | --- |
| R1 | SA-MP 0.3.7 R1; PE entry-point RVA `0x31DF13` | `samp.dll`; SHA-256 `7E30F3C9CD99D5E2932410F486E8139AFFA2DAD19BD65AD9C328F6A4071943F7` | Recognized in the pinned live run | Ready during the 2026-08-29 full profile probe (`status=0x3FFFFFFF`, `failure=0`). |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| R1 | Profile identity and PE entry point | R1 identity matched in the pinned run | Ready in the full probe | Recognized | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A | Runtime uses the entry point; the hash identifies the tested artifact. |
| R1 | Host lifecycle and RakClient hook readiness | R1 identity matched | Ready observed in the full probe | Live-tested attach and readiness | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); `sdk/src/host_api/status.rs` | A + U | The active loader does not expose live host unload; hook restoration remains test-backed. |
| R1 | Network codec and exact-bit packet/RPC paths | R1 identity matched | Ready and receiver captured | Live-tested for the named network surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); packet/RPC tests | A | The aggregate run does not prove every possible Packet/RPC payload. |
| R1 | Outbound delivery and incoming original-handler continuation | R1 identity matched | Ready in the loopback run | Live-tested for the probe messages | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A | The result covers the fixed probe flow, not every RPC. |
| R1 | Disconnect, reconnect, and hook/vtable restoration | R1 identity matched | Reconnect passed in the full probe | Partial: reconnect, invalidation, and post-reconnect paths tested | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); hook lifecycle tests | A + U | Live DLL unload is unavailable; restoration is covered by process-exit/unit lifecycle tests. |
| R1 | Game state and server metadata caches | R1 identity matched | Game-thread cache published | Live-tested for the named scalar surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | Other R1 non-layout facts remain unresolved in the register. |
| R1 | Local-player snapshot and local-player mutations | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | The run does not promote unexercised operations or unresolved facts. |
| R1 | Player-pool scalars and remote-player records | R1 identity matched | Game-thread cache published | Live-tested for one fixture NPC and local player | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | The run does not prove every remote-player state or unregistered value. |
| R1 | Local/remote sync snapshots and force-send operations | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe sync surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | Coverage is limited to the sync records and force-send paths named by the probe. |
| R1 | Entity pools and existence reads | R1 identity matched | Game-thread cache published | Live-tested for the probe entity surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | Unexercised helpers and unresolved facts remain open. |
| R1 | GTA handle conversion | R1 identity matched | Ready with valid pool state | Live-tested for probe entity round trips | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | The run does not prove arbitrary native handles. |
| R1 | Chat display, chat history, and death window | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe UI surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | Unexercised history/detail paths retain their independent evidence status. |
| R1 | Chat input and command registry | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe command surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | Other DXUT/native facts remain governed by the register. |
| R1 | Dialog core, snapshots, controls, response hook, and mutations | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe dialog surface | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | The aggregate run does not prove every dialog layout field. |
| R1 | Cursor and scoreboard | R1 identity matched | Game-thread cache and command pump ready | Live-tested for the probe transitions | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29) | A + U | Unexercised native states retain their independent evidence status. |
| R1 | 3D text labels | R1 identity matched | Game-thread cache and command pump ready | Live-tested create/read/update/delete lifecycle | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | The register remains authoritative for other label facts. |
| R1 | Textdraws | R1 identity matched | Game-thread cache and command pump ready | Live-tested create/read/mutate/delete lifecycle | [Final four-profile matrix](native-layout-smoke.md#final-four-profile-matrix-2026-08-29); evidence register | A + U | The register remains authoritative for other textdraw facts. |
...
| R1 | Animation catalog and send rates | Recognized R1 required | Game-thread cache or command pump required | Implemented; evidence pending | `src/platform/win32/native_client/players/`; evidence register | C/U | Animation and send-rate native facts remain unverified. |
...
| R3-1 | Animation catalog and send rates | R3-1 identity matched | Not established for this family | Implemented; unverified | `src/platform/win32/native_client/players/`; evidence register | C/U | The R3 full probe summary does not claim the animation catalog/send-rate family. |
