...
| Native backend | `src/platform/win32.rs`, `src/platform/win32/r1_client.rs`, `src/platform/win32/r1_client/addresses.rs`, `src/client.rs` | Select networking offsets, own hooks, keep approved R1/GTA addresses separate from native layouts, and validate every direct access. |
