...
unsafe extern "system" fn test_vehicle_sync(
    id: u16,
    output: *mut crate::SampClientSdkInCarSyncV1,
) -> SampClientSdkResult {
    let Some(output) = (unsafe { output.as_mut() }) else {
        return SampClientSdkResult::InvalidArgument;
    };
    *output = if id == 7 {
        crate::SampClientSdkInCarSyncV1 {
            exists: 1,
            driver_health: 75,
            driver_armour: 25,
            weapon: 24,
        ...
        crate::SampClientSdkInCarSyncV1::default()
    };
    SampClientSdkResult::Ok
}
...
unsafe extern "system" fn test_submit_force_aim_sync(
    receipt: *mut crate::SampClientSdkCommandReceipt,
) -> SampClientSdkResult {
    unsafe { test_submit_command(receipt, 23) }
}
...
unsafe extern "system" fn test_submit_force_trailer_sync(
    trailer: u16,
    receipt: *mut crate::SampClientSdkCommandReceipt,
) -> SampClientSdkResult {
    if trailer >= crate::MAX_SAMP_VEHICLES {
        return SampClientSdkResult::InvalidArgument;
    }
    unsafe { test_submit_command(receipt, 26) }
}

unsafe extern "system" fn test_submit_force_vehicle_sync(
    vehicle: u16,
    receipt: *mut crate::SampClientSdkCommandReceipt,
) -> SampClientSdkResult {
