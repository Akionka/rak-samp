...
const REMOTE_PLAYER_PROCESS_ANIMATION_SIGNATURE_OFFSET: usize = 0x1A6;
...
// This interior of `CRemotePlayer::Update(OnfootData, TICK)` copies the exact
// 68-byte R1 on-foot record, updates reported health/armour, and stores special
// action. It is pinned now as a prerequisite for the future owned snapshot.
const REMOTE_PLAYER_UPDATE_ONFOOT_FIELDS_SIGNATURE: [u8; 104] = [
    0x8D, 0xBD, 0xC8, 0x00, 0x00, 0x00, 0xB9, 0x11, 0x00, 0x00, 0x00, 0x8B, 0xF3, 0xF3, 0xA5, 0x0F,
    0xB6, 0x53, 0x22, 0x89, 0x54, 0x24, 0x18, 0xDB, 0x44, 0x24, 0x18, 0xD9, 0x9D, 0xBC, 0x01, 0x00,
    0x00, 0x0F, 0xB6, 0x43, 0x23, 0x89, 0x44, 0x24, 0x18, 0xC6, 0x85, 0xC4, 0x01, 0x00, 0x00, 0x10,
    0xDB, 0x44, 0x24, 0x18, 0xD9, 0x9D, 0xB8, 0x01, 0x00, 0x00, 0x56, 0xE8, 0xAF, 0x8A, 0x2A, 0x00,
...
unsafe fn r1_targets_match(module_base: usize) -> bool {
    ...
    code_matches(show, &DIALOG_SHOW_SIGNATURE)
        ...
        && code_matches(
            module_base
                + REMOTE_PLAYER_PROCESS_RVA
                + REMOTE_PLAYER_PROCESS_ANIMATION_SIGNATURE_OFFSET,
...
mod tests {
    use super::{
        ...
        GANGZONE_POOL_NOT_EMPTY_OFFSET, GTA_SA_10_US_ENTRY_POINT, GTA_SA_10_US_IMAGE_BASE,
        ...
        REMOTE_PLAYER_PROCESS_ANIMATION_SIGNATURE,
        REMOTE_PLAYER_PROCESS_ANIMATION_SIGNATURE_OFFSET, REMOTE_PLAYER_PROCESS_RVA,
    ...
    #[test]
    fn remote_animation_signature_offset_matches_the_fingerprinted_r1_rva() {
        assert_eq!(
            REMOTE_PLAYER_PROCESS_RVA + REMOTE_PLAYER_PROCESS_ANIMATION_SIGNATURE_OFFSET,
            0x13096
        );
    }
